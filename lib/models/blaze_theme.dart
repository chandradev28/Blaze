...
class BlazeTheme {
  ...
  static const presets = <BlazeTheme>[
    BlazeTheme(
      id: 'blaze-core',
      name: 'Blaze Core',
      subtitle: 'The reference instrument',
    ...
    BlazeTheme(
      id: 'grand-prix',
      name: 'Redline',
      subtitle: 'High-contrast instrument',
    ...
    BlazeTheme(
      id: 'moto-circuit',
      name: 'Ice Face',
      subtitle: 'Cool instrument markings',
    ...
    BlazeTheme(
      id: 'electric-pulse',
      name: 'Volt',
      subtitle: 'Signal-green instrument',
    ...
    BlazeTheme(
      id: 'rally-storm',
      name: 'Amber',
      subtitle: 'Warm instrument markings',
    ...
    BlazeTheme(
      id: 'neon-street',
      name: 'Midnight',
      subtitle: 'Low-light instrument face',
